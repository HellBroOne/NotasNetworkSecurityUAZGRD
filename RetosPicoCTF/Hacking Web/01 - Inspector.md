...
Kishor Balan nos advirtió que es posible que sea necesario inspeccionar el siguiente código: `https://jupiter.challenges.picoctf.org/problem/41511/` ([link](https://jupiter.challenges.picoctf.org/problem/ 41511/)) o http://jupiter.challenges.picoctf.org:41511
### Pistas
1. How do you inspect web code on a browser?
2. There's 3 parts
### Solución
1. Para la primera bandera hay que dar clic derecho y obtenerla en el código fuente: ```
|   |   |
|---|---|
||<!doctype html>|
||<html>|
...
||</body>|
||</html>|```
2. Para la segunda bandera hay que abrir el inspector y encontrar la bandera en la hoja de estilos:
```
div.container {
    width: 100%;
}
...
```
3. Para la ultima bandera hay que localizar el javascript:
```
...
Simplemente hay que entrar al inspector de páginas web y encontrar.
### Referencias
