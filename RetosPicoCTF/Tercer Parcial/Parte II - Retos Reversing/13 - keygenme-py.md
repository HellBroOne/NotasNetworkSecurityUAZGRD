...
### Solución
```
┌──(loro㉿KaliLinux)-[~/keygenme]
└─$ wget https://mercury.picoctf.net/static/5a4198cd84f87c8a597cbd903d92fbf4/keygenme-trial.py
--2024-05-14 19:58:05--  https://mercury.picoctf.net/static/5a4198cd84f87c8a597cbd903d92fbf4/keygenme-trial.py
...
2024-05-14 19:58:06 (210 MB/s) - ‘keygenme-trial.py’ saved [10200/10200]
...
To which system do you want to travel? Solar
...
SOL is detected as your nearest star.
To which system do you want to travel? SOL
...
┌──(loro㉿KaliLinux)-[~/keygenme]
└─$ mousepad keygenme-trial.py

(mousepad:152520): GtkSourceView-WARNING **: 20:01:10.382: no color named 'yellow'
...
```
### Notas Adicionales
Se tuvo que obtener los indices de como se iban a agregar las partes dinamicas con la lista de posiciones de: [4,5,3,6,2,7,1,8].
### Referencias
